...
public sealed class ReadOnlyMemoryCloudEventExtensionsTests
{
    [Fact]
    ...
    [Fact]
    public void ReadResultWithCloudEventEnvelopeOfT_ShouldExposeEnvelopeAndExtensionAttributes()
    {
        var cloudEvent = CreateUtf8(
            """
            {
        ...
        var envelope = cloudEvent.ReadResultWithCloudEventEnvelope<int>();
