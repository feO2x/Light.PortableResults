...
public sealed record LightResultsHttpWriteOptions
{
    ...
    /// <see cref="ValidationProblemSerializationFormat.Rich" /> to get the most out of Light.PortableResults.
    /// </para>
    /// </summary>
    ...
    /// </para>
    /// <para>
    /// The default value is set to <see cref="SharedJsonSerialization.MetadataSerializationMode.ErrorsOnly" /> to be backwards-compatible
    /// with default ASP.NET Core behavior. We encourage you to set this to
    /// <see cref="SharedJsonSerialization.MetadataSerializationMode.Always" /> to get the most out of Light.PortableResults.
    /// </para>
    /// </summary>
