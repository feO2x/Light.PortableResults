...
/* /Users/kenny/Code/Light.PortableResults/src/Light.PortableResults/MetadataExtensions/Tracing.cs(30,34): error CS8620: Argument of type '(string Key, MetadataValue Value)' cannot be used for parameter 'properties' of type '(string Key, MetadataValue Value)[]' in 'T extension<T>(T).MergeMetadata(params (string Key, MetadataValue Value)[] properties)' due to differences in the nullability of reference types. [/Users/kenny/Code/Light.PortableResults/src/Light.PortableResults/Light.PortableResults.csproj]
   /Users/kenny/Code/Light.PortableResults/src/Light.PortableResults/MetadataExtensions/Tracing.cs(38,34): error CS8620: Argument of type '(string Key, MetadataValue Value)' cannot be used for parameter 'properties' of type '(string Key, MetadataValue Value)[]' in 'T extension<T>(T).MergeMetadata(params (string Key, MetadataValue Value)[] properties)' due to differences in the nullability of reference types. [/Users/kenny/Code/Light.PortableResults/src/Light.PortableResults/Light.PortableResults.csproj]
   /Users/kenny/Code/Light.PortableResults/src/Light.PortableResults/MetadataExtensions/Tracing.cs(52,17): error CS8620: Argument of type '(string Key, MetadataValue Value)' cannot be used for parameter 'properties' of type '(string Key, MetadataValue Value)[]' in 'T extension<T>(T).MergeMetadata(params (string Key, MetadataValue Value)[] properties)' due to differences in the nullability of reference types. [/Users/kenny/Code/Light.PortableResults/src/Light.PortableResults/Light.PortableResults.csproj]
   /Users/kenny/Code/Light.PortableResults/src/Light.PortableResults/MetadataExtensions/Tracing.cs(53,17): error CS8620: Argument of type '(string Key, MetadataValue Value)' cannot be used for parameter 'properties' of type '(string Key, MetadataValue Value)[]' in 'T extension<T>(T).MergeMetadata(params (string Key, MetadataValue Value)[] properties)' due to differences in the nullability of reference types. [/Users/kenny/Code/Light.PortableResults/src/Light.PortableResults/Light.PortableResults.csproj]
       0 Warning(s)
       4 Error(s)
