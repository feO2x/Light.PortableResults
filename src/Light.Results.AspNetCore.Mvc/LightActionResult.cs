...
/// </summary>
public sealed class LightActionResult : BaseLightActionResult<Result>
{
    /// <summary>
    /// Initializes a new instance of <see cref="LightActionResult" />.
    /// </summary>
...
{
    /// <summary>
    /// Initializes a new instance of <see cref="LightActionResult{T}" />.
    /// </summary>
    /// <param name="result">The result to execute.</param>
    /// <param name="successStatusCode">Optional success status code override.</param>
    /// <param name="location">Optional Location header value.</param>
