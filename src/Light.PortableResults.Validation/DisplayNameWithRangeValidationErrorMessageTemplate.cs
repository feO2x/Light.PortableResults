...
/// </summary>
public sealed class DisplayNameWithRangeValidationErrorMessageTemplate : IRangeValidationErrorMessageTemplate
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="DisplayNameWithRangeValidationErrorMessageTemplate" />.
    /// </summary>
    ...
    public DisplayNameWithRangeValidationErrorMessageTemplate(
    ...
    )
    {
        ...
        var formattedLowerBoundary = ValidationErrorMessageFormatting.FormatParameter(lowerBoundary, validationContext);
        var formattedUpperBoundary = ValidationErrorMessageFormatting.FormatParameter(upperBoundary, validationContext);
