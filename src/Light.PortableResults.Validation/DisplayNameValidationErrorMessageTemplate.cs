...
/// </summary>
public sealed class DisplayNameValidationErrorMessageTemplate : IValidationErrorMessageTemplate
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="DisplayNameValidationErrorMessageTemplate" /> class.
    /// </summary>
    ...
    public DisplayNameValidationErrorMessageTemplate(string suffix, string? key = null, string prefix = "")
    {
