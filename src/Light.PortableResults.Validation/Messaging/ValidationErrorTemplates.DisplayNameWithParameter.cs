...
public sealed partial record ValidationErrorTemplates
{
    ...
    public sealed class DisplayNameWithParameter<TParameter> : IValidationErrorMessageTemplate<TParameter>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DisplayNameWithParameter{TParameter}" /> class.
        /// </summary>
        ...
        public DisplayNameWithParameter(
