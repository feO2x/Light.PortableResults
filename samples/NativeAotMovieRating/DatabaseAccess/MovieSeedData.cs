...
public static class MovieSeedData
{
    ...
    [
        ...
        new () { Id = Guid.Parse("F9C0587B-EC34-4621-8002-C4A73A510C22"), Title = "Top Gun: Maverick" },
        new () { Id = Guid.Parse("6904799C-FE42-4426-8B6B-7F890FFD189E"), Title = "Spiderman: No Way Home" },
        new () { Id = Guid.Parse("EA643D21-22B7-42E0-A441-E617A718CD75"), Title = "Arrival" },
        new () { Id = Guid.Parse("26C665AF-01B0-4FE1-9201-D2ABD10A60AA"), Title = "The Revenant" },
        new () { Id = Guid.Parse("B0FB6CBD-9B68-4A8C-9025-D1B98926306D"), Title = "Birdman" },
        new () { Id = Guid.Parse("9B37EA5A-0449-46FA-9B7C-4BC3EB9AC073"), Title = "12 Years a Slave" },
        new () { Id = Guid.Parse("1BD9BECA-5ADB-4881-BB25-7DACF91E057C"), Title = "The Wolf of Wall Street" },
        new () { Id = Guid.Parse("511A3385-B6DE-4209-945E-0CF2F32A7DDE"), Title = "Her" },
        new () { Id = Guid.Parse("BFD4BF40-BCC4-479C-AEE0-4883215655AB"), Title = "The Social Network" },
        new () { Id = Guid.Parse("FC24F97C-E0B0-4E41-838C-39324E525837"), Title = "No Country for Old Men" },
        new () { Id = Guid.Parse("CB00913C-711A-4192-8F41-A6A307E4B810"), Title = "There Will Be Blood" },
        new () { Id = Guid.Parse("4CFBA432-7CB3-4CA7-947D-700AEF4D5B6D"), Title = "Pan's Labyrinth" },
        new () { Id = Guid.Parse("60037147-C57E-432E-9E0F-27D61C9E6831"), Title = "Casino Royale" },
        new () { Id = Guid.Parse("69962478-9C6C-40C3-9769-B88CC2C789DF"), Title = "Million Dollar Baby" },
        new () { Id = Guid.Parse("F0350245-6808-4D3B-B739-C6A463B1B712"), Title = "Big Fish" },
        new () { Id = Guid.Parse("5C23733B-93CE-4995-93C0-A18151EA5C34"), Title = "Catch Me If You Can" },
        new () { Id = Guid.Parse("0B770635-32C0-45D9-AC60-ED8C6083CBF5"), Title = "The Truman Show" },
