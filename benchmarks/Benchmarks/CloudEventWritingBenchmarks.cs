...
public class CloudEventWritingBenchmarks
{
    ...
    [Benchmark]
    public byte[] ToCloudEvent_NonGenericSuccess_LegacyDirect()
    {
        return ToCloudEventLegacyDirect(
    ...
    [Benchmark]
    public byte[] ToCloudEvent_NonGenericFailure_LegacyDirect()
    {
        return ToCloudEventLegacyDirect(
    ...
    [Benchmark]
    public byte[] ToCloudEvent_GenericSuccess_LegacyDirect()
    {
        return ToCloudEventLegacyDirect(
    ...
    [Benchmark]
    public byte[] ToCloudEvent_GenericFailure_LegacyDirect()
    {
        return ToCloudEventLegacyDirect(
    ...
    [Benchmark]
    public byte[] ToCloudEvent_GenericSuccessWithMetadata_LegacyDirect()
    {
        return ToCloudEventLegacyDirect(
    ...
    private byte[] ToCloudEventLegacyDirect(
        Result result,
        string successType,
        string failureType,
        string id
    ...
    private byte[] ToCloudEventLegacyDirect<T>(
        Result<T> result,
        string successType,
        string failureType,
        string id
